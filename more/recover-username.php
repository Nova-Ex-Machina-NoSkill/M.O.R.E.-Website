...
<html lang="en-US">
	<head>
		<title>M.O.R.E. - Recover Username</title>
		<meta charset="UTF-8" />
	...
	<body>
		...
		<main>
			...
			<div id="main-body">
				<div id="container">
					<form class="form-center" action="php/recover_username.php" method="POST">
						<label for="recover-username">E-mail: </label>
						<input id="recover-username" name="recover-username" type="email" placeholder="example@more.com" /><br />
