	...
	<body>
		...
		<main>
			<div id="container">
				...
				<img id="left-arrow" src="img/gallery/arrows/arrow-left.png" alt="arrow left" />
				<img id="right-arrow" src="img/gallery/arrows/arrow-right.png" alt="arrow right" />
