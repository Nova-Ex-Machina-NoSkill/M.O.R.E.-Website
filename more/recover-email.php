...
<html lang="en-US">
	<head>
		<title>M.O.R.E. - Recover Email</title>
		<meta charset="UTF-8" />
	...
	<body>
		...
		<main>
			...
			<div id="main-body">
				<div id="container">
					<form class="form-center" action="php/recover_email.php" method="POST">
						<label for="recover-email">Username: </label>
						<input id="recover-email" name="recover-email" type="text" /><br />
